...
+
. Move `_jquery-3.4.1.min.js` into your https://docs.ankiweb.net/#/files[collection.media directory]
...
This deck supports the default fields of the add-on, so you should just run it normally and the related vocab will appear formatted.
